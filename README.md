This GitHub repository loads the current data set of Netflix, "netflix_titles.csv", and obtains some basic information about the data set and visualizes it.
